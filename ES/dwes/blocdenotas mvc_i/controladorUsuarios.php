    ...
    switch ($accion) {
        case "acceder":
            ...
            if ($ok == true) {
                ...
                // Ya no podemos utilizar variables locales porque nos 
                // movemos de página y por lo tanto hay dos formas:
                // $mensaje = "Usuario incorrecto";
                // O gurdo el mensaje en la sesión
                $_SESSION["mensaje"]="Usuario incorrecto";
                header("Location: index.php");
                // O lo paso como argumento por la URL 
                // header("Location: index.php?mensaje=Uusuario incorrecto");
