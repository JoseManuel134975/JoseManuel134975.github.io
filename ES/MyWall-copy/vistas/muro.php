...
<body>
    <form class="tuMuro" action="" enctype="multipart/form-data" method="post">
        <h2>Tu próxima publicación</h2>
        <textarea name="contenido" rows="10" cols="120" id="publicar"></textarea>
        <div>
            <input id="crearPublic" type="submit" name="accionmuros" value="Crear publicacion">
            <input type="file" name="subirImagen" id="" accept="image/*" value="">
        </div>
    </form>
